import { getOne } from "@/services/wishes.service";
...
export default async function SinglePage({ params }: Props) {
    ...
    const wish = await getOne(String(awaitedParams.id));
                            ...
                            {wish.link && (
                                <div>
                                    ...
                                    >
                                        ...
                                        <span className="truncate">{wish.link}</span>
                                    </a>
                                </div>
                            )}
                    ...
                    <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div className="bg-gray-800 rounded-lg p-4 text-center border border-gray-700">
                            <div className="text-2xl font-bold text-white mb-1">
                                {wish.priority === "HIGH" ? "🚨" : wish.priority === "MEDIUM" ? "⚠️" : "📋"}
                            </div>
                            <div className="text-sm text-gray-400">Приоритет</div>
                            <div className="text-white font-medium">{getPriorityText(wish.priority)}</div>
                        </div>
                        ...
                        <div className="bg-gray-800 rounded-lg p-4 text-center border border-gray-700">
                            ...
                            <div className="text-white font-medium truncate">{wish.user.name}</div>
                        </div>
                    </div>
                </div>
            </div>

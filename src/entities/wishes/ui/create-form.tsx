...
import {useCreate} from "@/entities/wishes/hooks/useCreate";
...
export const CreateFormUi: React.FC<Props> = ({ label = "Форма создания", className }) => {
    ...
    {/* Вывод хука для создания желания */}
        ...
        <div className={`${className} p-5 sm:p-10 w-full bg-zinc-800 rounded-lg`}>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <button
                    ...
                    className="px-3 h-12 font-medium text-gray-500 bg-zinc-700 hover:bg-zinc-900 cursor-pointer text-white rounded-full cursor-pointer">{isSubmitting ? "Создание желания...." : "Создать желание"}</button>
            </form>
        </div>
    );
};